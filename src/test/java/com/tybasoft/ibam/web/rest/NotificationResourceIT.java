...
public class NotificationResourceIT {
    ...
    private static final Boolean UPDATED_VISUALISE = true;
    ...
    public void createNotification() throws Exception {
        ...
        assertThat(testNotification.getSource()).isEqualTo(DEFAULT_SOURCE);
        assertThat(testNotification.isVisualise()).isEqualTo(DEFAULT_VISUALISE);
    }
    ...
    public void getAllNotifications() throws Exception {
        ...
        restNotificationMockMvc.perform(get("/api/notifications?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].visualise").value(hasItem(DEFAULT_VISUALISE.booleanValue())));
    }
    ...
    public void getNotification() throws Exception {
        ...
        restNotificationMockMvc.perform(get("/api/notifications/{id}", notification.getId()))
            ...
            .andExpect(jsonPath("$.visualise").value(DEFAULT_VISUALISE.booleanValue()));
    }
    @Test
    @Transactional
    ...
    public void updateNotification() throws Exception {
        ...
        assertThat(testNotification.getSource()).isEqualTo(UPDATED_SOURCE);
        assertThat(testNotification.isVisualise()).isEqualTo(UPDATED_VISUALISE);
    }
