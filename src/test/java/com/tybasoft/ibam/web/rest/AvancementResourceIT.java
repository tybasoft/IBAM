...
public class AvancementResourceIT {
    ...
    private static final String DEFAULT_TITRE_COMPTE_RENDU = "AAAAAAAAAA";
    private static final String UPDATED_TITRE_COMPTE_RENDU = "BBBBBBBBBB";

    private static final String DEFAULT_CONTENU_COMPTE_RENDU = "AAAAAAAAAA";
    private static final String UPDATED_CONTENU_COMPTE_RENDU = "BBBBBBBBBB";
    ...
    public static Avancement createEntity(EntityManager em) {
        Avancement avancement = new Avancement()
            ...
            .titreCompteRendu(DEFAULT_TITRE_COMPTE_RENDU)
            .contenuCompteRendu(DEFAULT_CONTENU_COMPTE_RENDU);
        return avancement;
    }
    /**
    ...
    public static Avancement createUpdatedEntity(EntityManager em) {
        Avancement avancement = new Avancement()
            ...
            .titreCompteRendu(UPDATED_TITRE_COMPTE_RENDU)
            .contenuCompteRendu(UPDATED_CONTENU_COMPTE_RENDU);
        return avancement;
    }
    ...
    public void createAvancement() throws Exception {
        ...
        assertThat(testAvancement.getTitreCompteRendu()).isEqualTo(DEFAULT_TITRE_COMPTE_RENDU);
        assertThat(testAvancement.getContenuCompteRendu()).isEqualTo(DEFAULT_CONTENU_COMPTE_RENDU);
    }
    ...
    public void getAllAvancements() throws Exception {
        ...
        restAvancementMockMvc.perform(get("/api/avancements?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].titreCompteRendu").value(hasItem(DEFAULT_TITRE_COMPTE_RENDU)))
            .andExpect(jsonPath("$.[*].contenuCompteRendu").value(hasItem(DEFAULT_CONTENU_COMPTE_RENDU.toString())));
    }
    ...
    public void getAvancement() throws Exception {
        ...
        restAvancementMockMvc.perform(get("/api/avancements/{id}", avancement.getId()))
            ...
            .andExpect(jsonPath("$.titreCompteRendu").value(DEFAULT_TITRE_COMPTE_RENDU))
            .andExpect(jsonPath("$.contenuCompteRendu").value(DEFAULT_CONTENU_COMPTE_RENDU.toString()));
    }
    @Test
    @Transactional
    ...
    public void updateAvancement() throws Exception {
        ...
        assertThat(testAvancement.getTitreCompteRendu()).isEqualTo(UPDATED_TITRE_COMPTE_RENDU);
        assertThat(testAvancement.getContenuCompteRendu()).isEqualTo(UPDATED_CONTENU_COMPTE_RENDU);
    }
