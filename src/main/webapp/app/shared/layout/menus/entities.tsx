...
export const EntitiesMenu = props => (
  ...
  >
    ...
    <MenuItem icon="asterisk" to="/situation-financiere">
      <Translate contentKey="global.menu.entities.situationFinanciere" />
    </MenuItem>
    <MenuItem icon="asterisk" to="/planification">
      <Translate contentKey="global.menu.entities.planification" />
    </MenuItem>
    <MenuItem icon="asterisk" to="/bon-sortie">
      <Translate contentKey="global.menu.entities.bonSortie" />
    </MenuItem>
    <MenuItem icon="asterisk" to="/ligne-bon-sortie">
      <Translate contentKey="global.menu.entities.ligneBonSortie" />
    </MenuItem>
    <MenuItem icon="asterisk" to="/stock-disponible">
      <Translate contentKey="global.menu.entities.stockDisponible" />
    </MenuItem>
    <MenuItem icon="asterisk" to="/ligne-stock-disponible">
      <Translate contentKey="global.menu.entities.ligneStockDisponible" />
    </MenuItem>
