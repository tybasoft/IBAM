...
import { AdminMenu, EntitiesMenu,MaterielMenu,ModulePersonnelMenu,MateriauMenu,AvancementMenu,ParametrageMenu,AccountMenu, LocaleMenu } from '../menus';
      ...
      <Navbar dark expand="sm" fixed="top" className="jh-navbar bg-primary">
        ...
        <Collapse isOpen={menuOpen} navbar>
          <Nav id="header-tabs" className="ml-auto" navbar>
            ...
            {props.isAuthenticated && (props.isChefMateriel || props.isMagasinier || 
             props.isResponsableEmp||props.isResponsableProjet||props.isChefMateriau)&&
