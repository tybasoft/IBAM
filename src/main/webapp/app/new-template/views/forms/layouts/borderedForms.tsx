          ...
          <Col sm="12">
            <Card>
              <CardBody>
                ...
                <p className="mb-0">
                  Add <code>.form-bordered</code> to form tag to add border to a form-group. In this example <code>.form-horizontal</code>{' '}
                  is used to show the bordered form functionality.
                </p>
                <div className="px-3">
          ...
          <Col sm="12">
            <Card>
              <CardBody>
                ...
                <p className="mb-0">
                  Add <code>.form-bordered</code> to form tag to add border to a form-group. In this example 2-column{' '}
                  <code>.form-horizontal</code> is used with primary color bordered form controls to show the bordered form functionality.
                </p>
                <div className="px-3">
                  <Form className="form-bordered form-horizontal">
                    <div className="form-body">
          ...
          <Col md="6">
            <Card>
              <CardBody>
                ...
                <p className="mb-0">
                  Add <code>.form-bordered</code> to form tag to add border to a form-group. In this example centered card is used to show
                  the bordered form functionality.
                </p>
                <div className="px-3">
                  <Form className="form-bordered form-horizontal">
                    <div className="form-body">
