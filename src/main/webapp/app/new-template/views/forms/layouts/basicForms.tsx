...
import { X, CheckSquare, User, Briefcase, MessageSquare, Clock, File, Info, FileText, Mail, AlertTriangle } from 'react-feather';
          ...
          <Col md="6">
            <Card>
              <CardBody>
                ...
                <p className="mb-0">
                  This is the most basic and default form having form sections. To add form section use <code>.form-section</code> class
                  with any heading tags. This form has the buttons on the bottom left corner which is the default position.
                </p>
                <div className="px-3">
                  <Form>
                    <div className="form-body">
                      ...
                      <h4 className="form-section">
                        <FileText size={20} color="#212529" /> Requirements
                      </h4>
          ...
          <Col md="6">
            <Card>
              <CardBody>
                ...
                <p className="mb-0">
                  You can always change the border color of the form controls using <code>border-*</code> class. In this example we have
                  used <code>border-primary</code> class for form controls. Form action buttons are on the bottom right position.
                </p>
                <div className="px-3">
                  <Form>
                    <div className="form-body">
                      <h4 className="form-section">
                        <Info size={20} color="#212529" /> About User
                      </h4>
                      <Row>
                        <Col md="6">
                          <FormGroup>
          ...
          <Col md="6">
            <Card>
              <CardBody>
                ...
                <p className="mb-0">
                  This form shows the use of icons with form controls. Define the position of the icon using <code>has-icon-left</code> or{' '}
                  <code>has-icon-right</code> class. Use <code>icon-*</code> class to define the icon for the form control. See Icons
                  sections for the list of icons you can use.{' '}
                </p>
                <div className="px-3">
                  <Form>
                    <div className="form-body">
          ...
          <Col md="6">
            <Card>
              <CardBody>
                ...
                <p className="mb-0">
                  This is a variation to the default form control styling. In this example all the form controls has round styling. To apply
                  round style add class <code>round</code> to any form control.
                </p>
                <div className="px-3">
                  <Form>
                    <div className="form-body">
          ...
          <Col md="6">
            <Card>
              <CardBody>
                ...
                <p className="mb-0">
                  This is another variation to the default form control styling. In this example all the form controls has square styling.
                  To apply square style add class <code>square</code> to any form control.
                </p>
                <div className="px-3">
                  <Form>
                    <div className="form-body">
          ...
          <Col md="12">
            <Card>
              <CardBody>
                ...
                <p className="mb-0">
                  This example shows a way to center your form in the card. Here we have used <code>.justify-content-md-center</code> class
                  to center the form in a full width card. User can always change columns according to his requirements. This example also
                  uses form action buttons in the center bottom position of the card.
                </p>
                <div className="px-3">
                  <Form>
          ...
          <Col md="6">
            <Card>
              <CardBody>
                <CardTitle>Event Registration</CardTitle>
                <p className="mb-0">
                  This example shows a ways to center your card with form. Here we have used <code>.justify-content-md-center</code> class
                  to center the card as its not full width. User can always change column according to his requirements. This example also
                  uses form action buttons in the center bottom position of the card.
                </p>
                <div className="px-3">
                  <Form>
