          ...
          <Col sm="12">
            <Card>
              <CardBody>
                ...
                <p className="mb-0">
                  Add <code>.striped-rows</code> to form tag to add striped rows. In this example <code>.form-horizontal</code> and{' '}
                  <code>.form-bordered</code> is used to show the striped rows functionality.
                </p>
                <div className="px-3">
          ...
          <Col sm="12">
            <Card>
              <CardBody>
                ...
                <p className="mb-0">
                  Add <code>.striped-rows</code> to form tag to add striped rows. In this example <code>.form-horizontal</code> and{' '}
                  <code>.form-bordered</code> is used to show the striped rows functionality. You can always change the border color of the
                  form controls using <code>border-*</code> class. In this example we have used <code>border-primary</code> class for form
                  controls.
                </p>
                <div className="px-3">
                  <Form className="striped-rows form-bordered form-horizontal">
