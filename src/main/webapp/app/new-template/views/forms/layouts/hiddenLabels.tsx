          ...
          <Col sm="12">
            <Card>
              <CardBody>
                ...
                <p className="mb-0">
                  This is the most basic and default form having form sections. Just add <code>hidden</code> attribute to a Label tag to
                  hide. To add form section use <code>.form-section</code> class with any heading tags. This form has the buttons on the
                  ...
                  <Form>
                    <div className="form-body">
                      ...
                      <Row>
                        <Col md="6">
                          <FormGroup>
                            <Label for="projectinput1" hidden>
                              First Name
                            </Label>
                        ...
                        <Col md="6">
                          <FormGroup>
                            <Label for="projectinput2" hidden>
                              Last Name
                            </Label>
                      ...
                      <Row>
                        <Col md="6">
                          <FormGroup>
                            <Label for="projectinput3" hidden>
                              E-mail
                            </Label>
                        ...
                        <Col md="6">
                          <FormGroup>
                            <Label for="projectinput4" hidden>
                              Contact Number
                            </Label>
                      ...
                      <Row>
                        <Col md="6">
                          <FormGroup>
                            <Label for="projectinput5" hidden>
                              Interested in
                            </Label>
                        ...
                        <Col md="6">
                          <FormGroup>
                            <Label for="projectinput6" hidden>
                              Budget
                            </Label>
                      ...
                      <FormGroup>
                        <Label for="projectinput8" hidden>
                          About Project
                        </Label>
          ...
          <Col sm="12">
            <Card>
              <CardBody>
                ...
                <p className="mb-0">
                  Just add <code>hidden</code> attribute to a label tag to hide. You can always change the border color of the form controls
                  using <code>border-*</code> class. In this example we have used <code>border-primary</code> class for form controls. Form
                  action buttons are on the bottom right position.
                </p>
                <div className="px-3">
                  <Form>
                    <div className="form-body">
          ...
          <Col md="6">
            <Card>
              <CardBody>
                ...
                <p className="mb-0">
                  Just add <code>hidden</code> attribute to a label tag to hide. Here we have used <code>.justify-content-md-center</code>{' '}
                  class to center the card as its not full width. User can always change column according to his requirements. This example
                  also uses form action buttons in the center bottom position of the card.
                </p>
                <div className="px-3">
                  <Form>
                    <div className="form-body">
                      <FormGroup>
                        <Label for="eventRegInput1" hidden>
                          Full Name
                        </Label>
                      ...
                      <FormGroup>
                        <Label for="eventRegInput2" hidden>
                          Title
                        </Label>
                      ...
                      <FormGroup>
                        <Label for="eventRegInput3" hidden>
                          Company
                        </Label>
                      ...
                      <FormGroup>
                        <Label for="eventRegInput4" hidden>
                          Email
                        </Label>
                      ...
                      <FormGroup>
                        <Label for="eventRegInput5" hidden>
                          Contact Number
                        </Label>
