...
import { X, CheckSquare, User, Info, FileText, Mail } from 'react-feather';
          ...
          <Col sm="12">
            <Card>
              <CardBody>
                ...
                <p className="mb-0">
                  This is the basic horizontal form with labels on left and form controls on right in one line. Add{' '}
                  <code>.form-horizontal</code> class to the form tag to have horizontal form styling. To define form sections use{' '}
                  <code>form-section</code> class with any heading tags.
                </p>
                <div className="px-3">
          ...
          <Col sm="12">
            <Card>
              <CardBody>
                ...
                <p className="mb-0">
                  This is 2-columns horizontal form with labels on left and form controls on right in one line. Add{' '}
                  <code>.form-horizontal</code> class to the form tag to have horizontal form styling. User can also change the border color
                  of the form controls using <code>border-*</code> class. In this example we have used <code>border-primary</code> class for
                  form controls.
                </p>
                <div className="px-3">
                  <Form className="form-horizontal">
          ...
          <Col md="6">
            <Card>
              <CardBody>
                ...
                <p className="mb-0">
                  Add <code>.form-horizontal</code> class to the form tag to have horizontal form styling. This is horizontal form demo with
                  centered card. Here we have used <code>.justify-content-md-center</code> class to center the card as its not full width.
                  User can always change column according to his requirements.
                </p>
                <div className="px-3">
                  <Form className="form-horizontal">
                    <div className="form-body">
                      <FormGroup row>
                        <Label for="eventRegInput1" sm={3}>
                          Full Name:
                        </Label>
                        <Col sm={9}>
