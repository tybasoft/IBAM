...
export default class StepZilla extends Component<any, any> {
  nextTextOnFinalActionStep: any;
  ...
  next() {
    this.abstractStepMoveAllowedToPromise(null)
      .then((proceed = true) => {
