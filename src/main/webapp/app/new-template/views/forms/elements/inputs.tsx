                    ...
                    <Col xl="4" lg="6" md="12">
                      <FormGroup>
                        ...
                        <Input type="select" id="basicselect" name="interested">
                          <option value="none" defaultValue={''} disabled={false}>
                            Select Option
                          </option>
                  ...
                  <Row>
                    <Col md="6" sm="12">
                      <FormGroup tag="fieldset">
                        ...
                        <FormGroup check>
                          <Label check>
                            <Input type="checkbox" defaultChecked /> Default Checkbox
                          </Label>
                        </FormGroup>
                        <FormGroup check>
                          <Label check>
                            <Input type="checkbox" /> Second Default Checkbox
                          </Label>
                        </FormGroup>
                        <FormGroup check>
                          <Label check>
                            <Input type="checkbox" disabled /> Default Checkbox
                          </Label>
                        </FormGroup>
                      </FormGroup>
                    </Col>
                  ...
                  <Row>
                    <Col md="6" sm="12">
                      <FormGroup tag="fieldset">
                        ...
                        <FormGroup check>
                          <Label check>
                            <Input type="radio" name="radio1" defaultChecked /> Default radio
                          </Label>
                        </FormGroup>
                        <FormGroup check>
                          <Label check>
                            <Input type="radio" name="radio1" /> Second default radio
                          </Label>
                        </FormGroup>
                        <FormGroup check disabled>
                          <Label check>
                            <Input type="radio" name="radio1" disabled /> Disabled radio
                          </Label>
                        </FormGroup>
                      </FormGroup>
                    </Col>
