  ...
  render() {
    return (
      <Fragment>
        ...
        <ContentSubHeader>
          We use{' '}
          <a href="https://getbootstrap.com/docs/4.1/layout/grid/" target="_blank" rel="noopener noreferrer">
            Bootstrap’s grid
          </a>{' '}
          system, It uses a series of containers, rows, and columns to layout and align content. It’s built with flexbox and is fully
          responsive. Below is an example and an in-depth look at how the grid comes together.{' '}
        </ContentSubHeader>
        <Row>
          <Col sm="12">
            <Card>
        ...
        <Row>
          <Col md="12">
            ...
            <p>
              Using a single set of <code>&lt;Col md="*"&gt;</code> grid classes, you can create a basic grid system that starts out stacked
              on mobile devices and tablet devices (the extra small to small range) before becoming horizontal on desktop (medium) devices.
