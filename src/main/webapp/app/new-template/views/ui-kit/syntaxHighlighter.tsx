  ...
  render() {
    return (
      <Fragment>
        ...
        <p>
          Apex React use{' '}
          <a href="react-prism" target="_blank">
            react-prism
          </a>{' '}
          for Syntax Highlighter. Put your code inside <code>&lt;PrismCode&gt;</code> component, and it will highlight it and wraps it into
          a <code>&lt;code&gt;</code> component:
        </p>
        <Row>
          {/* JavaScript Example */}
          <Col sm="12">
            <Card>
              <CardBody>
                ...
                <p>
                  You can use this component for JavaScript code by using{' '}
                  <code>&lt;PrismCode component="pre" className="language-javascript"&gt;..&lt;PrismCode&gt;</code>
                </p>
                <CustomTabs
          ...
          <Col sm="12">
            <Card>
              <CardBody>
                ...
                <p>
                  You can use this component for CSS code by using{' '}
                  <code>&lt;PrismCode component="pre" className="language-css"&gt;..&lt;PrismCode&gt;</code>
                </p>
                <CustomTabs
          ...
          <Col sm="12">
            <Card>
              <CardBody>
                ...
                <p>
                  You can use this component for HTML code by using{' '}
                  <code>&lt;PrismCode component="pre" className="language-markup"&gt;..&lt;PrismCode&gt;</code>
                </p>
                <CustomTabs
