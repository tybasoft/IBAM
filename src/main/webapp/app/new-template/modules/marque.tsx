...
import MarqueDetails from './marque-details';

const Marque = (props: any) => {
  console.log(props);
    ...
    <Fragment>
        ...
        <Col sm="12">
          <Card>
            <CardBody>
              ...
              <p>
                {' '}
                <Translate contentKey="ibamApp.marque.home.description">marque</Translate>
              </p>
              ...
              <div className="form-group mb-3 form-group-compose text-center">
                <Button type="button" onClick={() => setModalOpen(true)} className="btn float-left btn-raised btn-danger  my-2 shadow-z-2">
                  <Icon.Plus size={18} className="mr-1" /> <Translate contentKey="ibamApp.marque.home.createLabel">marque</Translate>
                </Button>
                <Button
      ...
      <Modal isOpen={modalOpen} toggle={() => handleClose()} size="md">
        <ModalHeader toggle={() => handleClose()}>
          <Translate contentKey="ibamApp.marque.home.createLabel">Entreprises</Translate>
        </ModalHeader>
        {/* <AddTodo /> */}
      ...
      {selectedEntity !== null && (
        <MarqueDetails selectedEntity={selectedEntity} setSelectedEntity={openDetails} isOpen={selectedEntity !== null} />
      )}
    </Fragment>
  );
};
