...
import { getEntity } from 'app/entities/employe/employe.reducer';
...
export const EmployeDetails = ({ handleClose, ...props }) => {
  const { id, employeEntity, imageEntity } = props;
...
export default connect<any, any, any>(mapStateToProps, mapDispatchToProps)(EmployeDetails);
