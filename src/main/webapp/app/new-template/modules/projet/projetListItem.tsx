  ...
  <li className={'list-group-item list-group-item-action no-border ' + (active === id ? 'bg-grey bg-lighten-4' : '')}>
    <Row className="email-list-group-item">
      ...
      <Col xs={9} onClick={onClick}>
        <h6 className=" text-bold-500 mb-1 mt-1">{libelle}</h6>
        <div>
          <p className="list-group-item-text text-truncate w-100">{description}</p>
          <span className="font-small-2 text-muted float-left">{dateDebut}</span>
