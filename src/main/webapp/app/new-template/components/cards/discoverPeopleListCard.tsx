...
class DiscoverPeopleCard extends PureComponent<{ discoverPeopleList; cardTitle }> {
  render() {
              ...
              <div key={i}>
                {[
                  <Media className="my-2" key={i}>
                    <Media left href="#">
                      <img src={object.img} className="media-object d-flex mr-3 bg-primary height-40 rounded-circle" alt="Card cap 02" />
                    </Media>
                    <Media body>
