          ...
          <div className="email-app-sidebar-content">
            <div className="email-app-menu">
              <div className="form-group form-group-compose text-center">
                <Button className="my-2 btn-raised shadow-z-2" color="danger" onClick={this.toggle} block>
                  {' '}
                  <Mail size={18} color="#FFFFFF" className="mr-1" /> Compose
                </Button>
              ...
              <div className="list-group list-group-messages">
                ...
                <FilterEmail filter={VisibilityFilters.SHOW_DRAFTS}>
                  <File className="mr-2" size={18} color="#212529" />
                  Drafts
                </FilterEmail>
                <FilterEmail filter={VisibilityFilters.SHOW_SPAM}>
                  <AlertCircle className="mr-2" size={18} color="#212529" />
                  Spam
                </FilterEmail>
                <FilterEmail filter={VisibilityFilters.SHOW_TRASH}>
                  <Trash className="mr-2" size={18} color="#212529" />
                  Trash
                </FilterEmail>
                ...
                <FilterEmail filter={VisibilityFilters.SHOW_STARRED}>
                  <Star className="mr-2" size={18} color="#212529" />
                  Starred
                </FilterEmail>
                <FilterEmail filter={VisibilityFilters.SHOW_IMPORTANT}>
                  <Pocket className="mr-2" size={18} color="#212529" />
                  Important
                </FilterEmail>
                ...
                <FilterEmail filter={VisibilityFilters.SHOW_TECHNOLOGY}>
                  <Tag className="mr-2 warning" size={18} />
                  Technology
                </FilterEmail>
                <FilterEmail filter={VisibilityFilters.SHOW_FINANCE}>
                  <Tag className="mr-2 success" size={18} />
                  Finance
                </FilterEmail>
                <FilterEmail filter={VisibilityFilters.SHOW_HEALTH}>
                  <Tag className="mr-2 danger" size={18} />
                  Health
                </FilterEmail>
              </div>
            </div>
