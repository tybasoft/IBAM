...
class ContactsFilter extends React.Component<any, any> {
  constructor(props) {
    super(props);
    this.state = {
      modal: false
          ...
          <div className="contact-app-sidebar-content">
            <div className="contact-app-menu">
              <div className="form-group form-group-compose text-center">
                <button type="button" className="btn btn-raised btn-danger btn-block my-2 shadow-z-2" onClick={this.toggle}>
              ...
              <ul className="list-group list-group-messages">
                <FilterLink filter={contactVisiblityFilter.ENGINEERING_DEPARTMENT_CONTACT} departmentValue="Engineering">
