...
import {CreateList} from 'app/entities/paie/paie.reducer';
  ...
  return (
    <div>
            ...
            <AvGroup>
                <Row >
                  <Col xs="4">
                  <AvInput id="date-debut" type="text" className="form-control" 
                  name="date-debut" placeholder="date de début"  required>
                   </AvInput>
                  </Col>
                  <Col xs="5">
                     <AvInput id="date-fin" type="text" className="form-control" 
                  name="date-fin" placeholder="date de fin"  required>
                   </AvInput>
                   </Col>
                  <Col xs="auto">
