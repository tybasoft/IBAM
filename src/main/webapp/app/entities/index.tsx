...
const Routes = ({ match }) => (
  <div>
    <Switch>
      ...
      <ErrorBoundaryRoute path={`${match.url}stock-disponible`} component={StockDisponible} />
      <ErrorBoundaryRoute path={`${match.url}ligne-stock-disponible`} component={LigneStockDisponible} />
