...
import { getEntities } from './ligne-bon-reception.reducer';
import { ILigneBonReception } from 'app/shared/model/ligne-bon-reception.model';
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';
import { ITEMS_PER_PAGE } from 'app/shared/util/pagination.constants';

export interface ILigneBonReceptionProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}
        ...
        {ligneBonReceptionList && ligneBonReceptionList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('quantite')}>
                  <Translate contentKey="ibamApp.ligneBonReception.quantite">Quantite</Translate> <FontAwesomeIcon icon="sort" />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ibamApp.ligneBonReception.home.notFound">No Ligne Bon Receptions found</Translate>
            </div>
          )
        )}
      </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(LigneBonReception);
