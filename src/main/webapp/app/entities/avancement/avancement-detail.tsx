...
<span>Rédacteur</span>   
  ...
  <div className="modal-dialog modal-dialog-centered" role="document">
    <div className="modal-content">
      <div className="modal-header">
        <h5 className="modal-title" id="exampleModalLongTitle">Envoyer le fichier a votre equipe </h5>
      ...
      <label for="mail">Destinataire</label>
        <Select
        id="mail_array"
  ...
  />
       ...
       <textarea className="form-control" name="" id="mail_message" cols="30" rows="10" value={defaultMessage} >
