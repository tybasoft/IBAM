            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('titreCompteRendu')}>
                  <Translate contentKey="ibamApp.avancement.titreCompteRendu">Titre Compte Rendu</Translate> <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {avancementList.map((avancement, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{avancement.titreCompteRendu}</td>
                  <td>{avancement.contenuCompteRendu}</td>
                  <td>{avancement.employe ? <Link to={`employe/${avancement.employe.id}`}>{avancement.employe.id}</Link> : ''}</td>
