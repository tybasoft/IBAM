            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('titreCompteRendu')}>
                  <span >Compte rendu</span> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th>
                 <span>Rédacteur</span> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {avancementList.map((avancement, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{avancement.employe ? <Link to={`employe/${avancement.employe.id}`}>{avancement.employe.nom }</Link> : ''}</td>
