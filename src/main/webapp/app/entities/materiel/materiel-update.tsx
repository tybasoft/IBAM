...
export const MaterielUpdate = (props: IMaterielUpdateProps) => {
  ...
  const { materielEntity, familles, typeMateriels, fournisseurs, marques, documents, employes, images, projets, loading, updating } = props;
        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : materielEntity} onSubmit={saveEntity}>
              ...
              <AvGroup check>
                <Label id="multiProjetLabel">
                  <AvInput id="materiel-multiProjet" type="checkbox" className="form-check-input" name="multiProjet" />
