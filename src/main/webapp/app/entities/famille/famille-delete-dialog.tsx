...
export interface IFamilleDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}
...
export const FamilleDeleteDialog = (props: IFamilleDeleteDialogProps) => {
  ...
  const confirmDelete = () => {
    props.deleteEntity(props.familleEntity.id);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ibamApp.famille.delete.question">
        <Translate contentKey="ibamApp.famille.delete.question" interpolate={{ id: familleEntity.id }}>
          Are you sure you want to delete this Famille?
        </Translate>
      </ModalBody>
      <ModalFooter>
