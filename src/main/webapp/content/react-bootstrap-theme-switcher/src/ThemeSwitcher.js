...
ThemeSwitcher.defaultProps = {
  ...
  storeThemeKey: null,
  themes: ['default', 'yeti', 'superhero', 'pulse', 'lumen', 'darkly', 'simplex', 'cerulean', 'sandstone', 'cosmo', 'cyborg', 'slate', 'flatly', 'journal', 'litera', 'spacelab', 'united', 'lux', 'materia', 'minty', 'sketchy', 'solar']
};
